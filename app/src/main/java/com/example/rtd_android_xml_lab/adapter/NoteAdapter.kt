package com.example.rtd_android_xml_lab.adapter
...
import com.example.rtd_android_xml_lab.R
import com.example.rtd_android_xml_lab.data.entity.Note

class NoteAdapter(private val listener: OnItemClickListener) : ListAdapter<Note, NoteAdapter.NoteViewHolder>(DIFF_CALLBACK) {
